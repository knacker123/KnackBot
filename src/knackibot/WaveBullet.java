...
public class WaveBullet
{
	...
	private int    direction; //clockwise (1) or counterclockwise (-1) // TODO: think about using bool or enum
	...
	public boolean checkHit(double enemyX, double enemyY, long currentTime)
	{
		...
		if (Point2D.distance(startX, startY, enemyX, enemyY) <= 
				(currentTime - this.fireTime) * MyUtils.getBulletVelocity(this.power))
		{
